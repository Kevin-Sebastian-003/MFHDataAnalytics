...
# linear regression Using one predictor
slope, intercept, r_value, p_value, std_err = stats.linregress(X_train["REGION"], y_train)
...
# Predictions
y_pred = intercept + slope * X_test["REGION"]
...
# Scatter plot
plt.figure(figsize=(8, 6))
plt.scatter(X_test["REGION"], y_test, color='blue', alpha=0.5, label='Actual Data')
plt.plot(X_test["REGION"], y_pred, color='red', label='Regression Line')
